...
class SelfAttention(nn.Module):
    ...
    def forward(
        ...
        if use_flash_attn:
            ...
            attn_output = xops.memory_efficient_attention(query_layer, key_layer, value_layer, attn_bias=attn_bias, p=self.drop_prob)
        else:
...
def replace_roberta_attn(_use_flash_attn=True, _use_full=False, _rope_scaling=None, _replace_embedding=True):
